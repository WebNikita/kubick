...
jquery__WEBPACK_IMPORTED_MODULE_0__('.close_phone').on('click', function() {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0__(this).parent().parent().css('display', 'none');
...
jquery__WEBPACK_IMPORTED_MODULE_0__('.filter').children('li').on('click', function() {
  jquery__WEBPACK_IMPORTED_MODULE_0__(this).toggleClass('select');
  check(jquery__WEBPACK_IMPORTED_MODULE_0__(this));
});
...
jquery__WEBPACK_IMPORTED_MODULE_0__('[data-hover="catalog"]').hover(function() {
  jquery__WEBPACK_IMPORTED_MODULE_0__('[data-visible="second"]').toggleClass('active__inline');
  jquery__WEBPACK_IMPORTED_MODULE_0__('[data-visible="second"]').hover(function() {
...
function removeClass() {
  jquery__WEBPACK_IMPORTED_MODULE_0__('[data-hover="overalls"]').children().css('visibility', 'hidden');
...
jquery__WEBPACK_IMPORTED_MODULE_0__('[data-hover="overalls"]').hover(function() {
  removeClass();
  console.log(jquery__WEBPACK_IMPORTED_MODULE_0__(this));
  jquery__WEBPACK_IMPORTED_MODULE_0__(this).children().css('visibility', 'visible');
  ...
  console.log(jquery__WEBPACK_IMPORTED_MODULE_0__(this).children().outerHeight() + 20);
});
...
/* harmony import */ var _js_sidebar_list_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @js/sidebar_list.js */ "./style/js/sidebar_list.js");
...
/* harmony import */ var _js_header_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @js/header.js */ "./style/js/header.js");
/* harmony import */ var _js_header_mobile_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @js/header-mobile.js */ "./style/js/header-mobile.js");
