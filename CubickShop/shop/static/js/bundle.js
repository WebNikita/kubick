...
jquery__WEBPACK_IMPORTED_MODULE_0__('.sidebar__sort_phone').on('click', function() {
  console.log('on sort');
  jquery__WEBPACK_IMPORTED_MODULE_0__('.block__sort_phone').css('display', 'block');
  jquery__WEBPACK_IMPORTED_MODULE_0__('.container').css('opacity', '0.5');
});

jquery__WEBPACK_IMPORTED_MODULE_0__('.sidebar__filter_phone').on('click', function() {
  console.log('on');
  jquery__WEBPACK_IMPORTED_MODULE_0__('.block__filter_phone').css('display', 'block');
  jquery__WEBPACK_IMPORTED_MODULE_0__('.container').css('opacity', '0.5');
});

jquery__WEBPACK_IMPORTED_MODULE_0__('.close_phone').on('click', function() {
  console.log('off');
  const mainBlock = jquery__WEBPACK_IMPORTED_MODULE_0__(this).parent().parent();
  mainBlock.css('display', 'none');
  if (mainBlock.hasClass('block__filter_phone') || mainBlock.hasClass('block__sort_phone')) {
    jquery__WEBPACK_IMPORTED_MODULE_0__('.container').css('opacity', '1');
  } else if (mainBlock.parent().hasClass('block__size') || mainBlock.parent().hasClass('block__append-to-card')) {
    jquery__WEBPACK_IMPORTED_MODULE_0__('.container').css('opacity', '1');
    mainBlock.css('display', 'grid');
    mainBlock.parent().css('display', 'none');
  } else {
    jquery__WEBPACK_IMPORTED_MODULE_0__('.sidebar__list_filter_phone').css('display', 'block');
    mainBlock.css('display', 'none');
  }
});
...
jquery__WEBPACK_IMPORTED_MODULE_0__('.quickly__preview_button').on('click', function() {
  ProductId = jquery__WEBPACK_IMPORTED_MODULE_0__(this).parent().parent().parent().attr('id');
  console.log(ProductId);
  console.log('on');

  const BlockPreview = jquery__WEBPACK_IMPORTED_MODULE_0__(`.block__preview#tr_${ProductId}`);
  console.log(BlockPreview.attr('id'));
...
jquery__WEBPACK_IMPORTED_MODULE_0__('.choice-size').on('click', function() {
  const Size = jquery__WEBPACK_IMPORTED_MODULE_0__(`.block__append-to-card#size_${ProductId}`);
  jquery__WEBPACK_IMPORTED_MODULE_0__(Size).css('display', 'block');
  jquery__WEBPACK_IMPORTED_MODULE_0__('.container').css('opacity', '0.5');
})

jquery__WEBPACK_IMPORTED_MODULE_0__('.close_preview').on('click', function() {
  console.log('off');
  jquery__WEBPACK_IMPORTED_MODULE_0__('.block__preview').css('display', 'none');
  jquery__WEBPACK_IMPORTED_MODULE_0__('.container').css('opacity', '1');
});

jquery__WEBPACK_IMPORTED_MODULE_0__('.close-size').on('click', function() {
  jquery__WEBPACK_IMPORTED_MODULE_0__(this).parent().parent().parent().parent().css('display', 'none');
  jquery__WEBPACK_IMPORTED_MODULE_0__('.container__product_preview').css('opacity', '1');
  jquery__WEBPACK_IMPORTED_MODULE_0__('.container__product_info').css('opacity', '1');
  jquery__WEBPACK_IMPORTED_MODULE_0__('.container__card').css('opacity', '1');
})
...
const filter = jquery__WEBPACK_IMPORTED_MODULE_0__('.filter').children();
jquery__WEBPACK_IMPORTED_MODULE_0__(filter).children().on('click', function() {
...
jquery__WEBPACK_IMPORTED_MODULE_0__(`.${SidebarListFilter}_first`).on('click', function() {
  jquery__WEBPACK_IMPORTED_MODULE_0__('.sidebar__list_filter_phone').css('display', 'none');
  jquery__WEBPACK_IMPORTED_MODULE_0__(`.${BlockFilter}_one`).css('display', 'block');
});

jquery__WEBPACK_IMPORTED_MODULE_0__(`.${SidebarListFilter}_second`).on('click', function() {
  jquery__WEBPACK_IMPORTED_MODULE_0__('.sidebar__list_filter_phone').css('display', 'none');
  jquery__WEBPACK_IMPORTED_MODULE_0__(`.${BlockFilter}_two`).css('display', 'block');
});

jquery__WEBPACK_IMPORTED_MODULE_0__(`.${SidebarListFilter}_third`).on('click', function() {
  jquery__WEBPACK_IMPORTED_MODULE_0__('.sidebar__list_filter_phone').css('display', 'none');
  jquery__WEBPACK_IMPORTED_MODULE_0__(`.${BlockFilter}_four`).css('display', 'block');
});
...
jquery__WEBPACK_IMPORTED_MODULE_0__(`.${SidebarListFilter}_five`).on('click', function() {
  jquery__WEBPACK_IMPORTED_MODULE_0__('.sidebar__list_filter_phone').css('display', 'none');
  jquery__WEBPACK_IMPORTED_MODULE_0__(`.${BlockFilter}_five`).css('display', 'block');
});
...
jquery__WEBPACK_IMPORTED_MODULE_0__('[data-button="menu-mobile"]').click(function() {
  jquery__WEBPACK_IMPORTED_MODULE_0__('.header-mobile').toggleClass('hd__active_block')
})

jquery__WEBPACK_IMPORTED_MODULE_0__('[data-button="list_2"]').click(function() {
  jquery__WEBPACK_IMPORTED_MODULE_0__(this).next().toggleClass('hd__active_block')
})

jquery__WEBPACK_IMPORTED_MODULE_0__('[data-button="header-back"]').click(function() {
  jquery__WEBPACK_IMPORTED_MODULE_0__(this).parent().toggleClass('hd__active_block')
})
...
const secondMenu = jquery__WEBPACK_IMPORTED_MODULE_0__('[data-visible="second"]')
const overalls = jquery__WEBPACK_IMPORTED_MODULE_0__('[data-hover="overalls"]')

jquery__WEBPACK_IMPORTED_MODULE_0__('[data-hover="catalog"]').hover(function() {
  secondMenu.addClass('active__inline')
...
secondMenu.hover(function() {
  jquery__WEBPACK_IMPORTED_MODULE_0__(this).addClass('active__inline')
}, function() {
  jquery__WEBPACK_IMPORTED_MODULE_0__(this).removeClass('active__inline')
  jquery__WEBPACK_IMPORTED_MODULE_0__('[data-hover="overalls"]').children().css('display', 'none')
  jquery__WEBPACK_IMPORTED_MODULE_0__('.header__background').css('height', 0)
  overalls.css({
    color: 'inherit',
    textDecoration: 'inherit',
  })
  jquery__WEBPACK_IMPORTED_MODULE_0__('[data-hover="catalog"]').css({
    color: 'inherit',
    textDecoration: 'inherit',
  })
})

overalls.hover(function() {
  removeClass()
  jquery__WEBPACK_IMPORTED_MODULE_0__(this).children().css('display', 'block')
  jquery__WEBPACK_IMPORTED_MODULE_0__(this).css({
    color: '#4C95BD',
    textDecoration: 'underline',
  })
  jquery__WEBPACK_IMPORTED_MODULE_0__('.header__background').css('height', jquery__WEBPACK_IMPORTED_MODULE_0__(this).children().outerHeight() + 20)
})
...
function removeClass() {
  ...
  overalls.children().css('display', 'none')
}

jquery__WEBPACK_IMPORTED_MODULE_0__('[data-focus="loop"]').click(function() {
  jquery__WEBPACK_IMPORTED_MODULE_0__(this).prev().toggleClass('active__grid')
  jquery__WEBPACK_IMPORTED_MODULE_0__(this).toggleClass('active__loop')
  jquery__WEBPACK_IMPORTED_MODULE_0__(this).parent().toggleClass('header__label_bd')
  console.log(jquery__WEBPACK_IMPORTED_MODULE_0__(this).parents('li').prev()
      .toggleClass('active__hide'))
  // console.log($('[data-focus="input"]')[0].value);
});
...
const $button = jquery__WEBPACK_IMPORTED_MODULE_0__('.block__product_preview_second-bottom_button-append');
// console.log($button);
...
jquery__WEBPACK_IMPORTED_MODULE_0__('.choice-size-product').on('click', function() {
  jquery__WEBPACK_IMPORTED_MODULE_0__('.block__append-to-card').css('display', 'block');
  jquery__WEBPACK_IMPORTED_MODULE_0__('.container').css('opacity', '0.5');
})

jquery__WEBPACK_IMPORTED_MODULE_0__('.open-size').on('click', function() {
  // console.log('on');
  jquery__WEBPACK_IMPORTED_MODULE_0__('.block__size').css('display', 'block');
  jquery__WEBPACK_IMPORTED_MODULE_0__('.container').css('opacity', '0.5');
});

jquery__WEBPACK_IMPORTED_MODULE_0__('.block__card_order_append').on('click', function() {
  // console.log('on');
  jquery__WEBPACK_IMPORTED_MODULE_0__('.block__append-order').css('display', 'block');
  jquery__WEBPACK_IMPORTED_MODULE_0__('.container').css('opacity', '0.5');
});
...
jquery__WEBPACK_IMPORTED_MODULE_0__(`.${$contentMen}`).on('click', function() {
  jquery__WEBPACK_IMPORTED_MODULE_0__(this).children(`.${$contentMen}_table`).toggleClass('display_block');
});
jquery__WEBPACK_IMPORTED_MODULE_0__(`.${$contentWomen}`).on('click', function() {
  jquery__WEBPACK_IMPORTED_MODULE_0__(this).children(`.${$contentWomen}_table`).toggleClass('display_block');
});
jquery__WEBPACK_IMPORTED_MODULE_0__(`.${$contentShoes}`).on('click', function() {
  jquery__WEBPACK_IMPORTED_MODULE_0__(this).children(`.${$contentShoes}_table`).toggleClass('display_block');
});
jquery__WEBPACK_IMPORTED_MODULE_0__(`.${$contentShirt}`).on('click', function() {
  jquery__WEBPACK_IMPORTED_MODULE_0__(this).children(`.${$contentShirt}_table`).toggleClass('display_block');
});
jquery__WEBPACK_IMPORTED_MODULE_0__(`.${$contentTee}`).on('click', function() {
  jquery__WEBPACK_IMPORTED_MODULE_0__(this).children(`.${$contentTee}_table`).toggleClass('display_block');
});
jquery__WEBPACK_IMPORTED_MODULE_0__(`.${$contentGlove}`).on('click', function() {
  jquery__WEBPACK_IMPORTED_MODULE_0__(this).children(`.${$contentGlove}_table`).toggleClass('display_block');
});
...
jquery__WEBPACK_IMPORTED_MODULE_0__('.sidebar__filter').hover(function() {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0__('.sidebar__list_filter').css('display', 'flex');
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0__(this).children('p').css('color', '#767676');
  jquery__WEBPACK_IMPORTED_MODULE_0__('.sidebar__list_filter').css('display', 'none');
  jquery__WEBPACK_IMPORTED_MODULE_0__('.filter__button').children().css('fill', '#767676');
...
jquery__WEBPACK_IMPORTED_MODULE_0__('.sidebar__sort').hover(function() {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0__('.sort__button').children().css('fill', '#767676');
...
jquery__WEBPACK_IMPORTED_MODULE_0__('.sidebar__reveal').hover(function() {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0__('.reveal__button').children().css('fill', '#767676');
  jquery__WEBPACK_IMPORTED_MODULE_0__('.reveal__button').css({transform: 'rotate(0deg)'});
});

// Открытие категорий

jquery__WEBPACK_IMPORTED_MODULE_0__('.filter_first_one-head').on('click', function() {
...
jquery__WEBPACK_IMPORTED_MODULE_0__('.filter_first_two-head').on('click', function() {
  console.log('on');
...
jquery__WEBPACK_IMPORTED_MODULE_0__('.filter_first_three-head').on('click', function() {
...
jquery__WEBPACK_IMPORTED_MODULE_0__('.filter_first_four-head').on('click', function() {
...
jquery__WEBPACK_IMPORTED_MODULE_0__('.filter_first_five-head').on('click', function() {
  jquery__WEBPACK_IMPORTED_MODULE_0__('.filter_first_five-button').toggleClass('on');
  jquery__WEBPACK_IMPORTED_MODULE_0__('.filter_first_five-content').toggleClass('on');
});

jquery__WEBPACK_IMPORTED_MODULE_0__('.page__list').children().on('click', function() {
...
/* harmony import */ var _js_catalog_phone_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @js/catalog_phone.js */ "./style/js/catalog_phone.js");
/* harmony import */ var _js_product_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @js/product.js */ "./style/js/product.js");
